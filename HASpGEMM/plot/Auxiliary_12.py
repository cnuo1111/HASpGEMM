import csv
matrix_to_max_perf1 = {} 
with open('12-spa.csv', 'r') as file1:
...
with open('12-spa.csv', 'r') as file2:
...
with open('result_SPA.csv', 'w', newline='') as file:
...
matrix_to_max_perf1 = {}  
with open('12-hash.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
...
with open('12-all.csv', 'r') as file2:
    reader = csv.reader(file2)
    rows = []
    for row in reader:
        matrix_name = row[1]
...
with open('result_HASH.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Matrix Name','nnz','cub', 'Max Perf (Method 1)', 'Max Perf (Method 2)', 'Speedup'])
    writer.writerows(rows)

matrix_to_max_perf1 = {}  
with open('12-esc.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
...
with open('result_ESC.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Matrix Name','nnz','cub', 'Max Perf (Method 1)', 'Max Perf (Method 2)', 'Speedup'])
    writer.writerows(rows)

matrix_to_max_perf1 = {}  
with open('12-mkl.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
...
with open('result_mkl.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Matrix Name','nnz','cub', 'Max Perf (Method 1)', 'Max Perf (Method 2)', 'Speedup'])
    writer.writerows(rows)