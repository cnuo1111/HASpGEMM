import csv
matrix_to_max_perf1 = {} 
with open('./DATA/12-spa.csv', 'r') as file1:
...
with open('./DATA/12-spa.csv', 'r') as file2:
...
matrix_to_max_perf1 = {}  
with open('./DATA/12-hash.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
...
with open('./DATA/12-all.csv', 'r') as file2:
    reader = csv.reader(file2)
    rows = []
    for row in reader:
        matrix_name = row[1]
...
matrix_to_max_perf1 = {}  
with open('./DATA/12-esc.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
...
matrix_to_max_perf1 = {}  
with open('./DATA/12-mkl.csv', 'r') as file1:
    reader = csv.reader(file1)
    for row in reader:
        matrix_name = row[1]
        max_perf = float(row[6])
